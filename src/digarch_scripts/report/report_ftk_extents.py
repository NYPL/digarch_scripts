...
def create_er_list(tree: etree.ElementTree) -> list[list[list[str], str, str]]:
    """
    ...
    for child in tree:
        ...
        if level >= 0:
            ...
            if possible_ref and hierarchy[-1].startswith("ER"):
                ...
                ers.append([hierarchy.copy(), refid, hierarchy[-1]])
...
def add_extents_to_ers(
    er_list: list[list[list[str], str, str]], bookmark_tables: list[dict]
